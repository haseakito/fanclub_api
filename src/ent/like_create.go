...
func (lc *LikeCreate) SetPostID(u uuid.UUID) *LikeCreate {
	lc.mutation.SetPostID(u)
	return lc
}

// SetNillablePostID sets the "post_id" field if the given value is not nil.
func (lc *LikeCreate) SetNillablePostID(u *uuid.UUID) *LikeCreate {
	if u != nil {
		lc.SetPostID(*u)
	}
	return lc
...
func (lc *LikeCreate) SetNillableUserID(s *string) *LikeCreate {
	if s != nil {
		lc.SetUserID(*s)
	}
	return lc
...
func (lc *LikeCreate) defaults() {
	if _, ok := lc.mutation.PostID(); !ok {
		v := like.DefaultPostID()
		lc.mutation.SetPostID(v)
	}
