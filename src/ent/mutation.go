...
func (m *LikeMutation) ResetPostID() {
	m.post = nil
	delete(m.clearedFields, like.FieldPostID)
}
...
func (m *LikeMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(like.FieldPostID) {
		fields = append(fields, like.FieldPostID)
	}
