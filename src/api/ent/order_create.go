...
func (oc *OrderCreate) SetPostID(id string) *OrderCreate {
	oc.mutation.SetPostID(id)
	return oc
}

// SetNillablePostID sets the "post" edge to the Post entity by ID if the given value is not nil.
func (oc *OrderCreate) SetNillablePostID(id *string) *OrderCreate {
	if id != nil {
		oc = oc.SetPostID(*id)
	}
	return oc
