...
type Post struct {
	...
	// MuxAssetID holds the value of the "mux_asset_id" field.
...
func (*Post) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case post.FieldID, post.FieldTitle, post.FieldDescription, post.FieldThumbnailURL, post.FieldVideoURL, post.FieldMuxAssetID, post.FieldMuxPlaybackID:
...
func (po *Post) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case post.FieldMuxAssetID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field mux_asset_id", values[i])
			} else if value.Valid {
				po.MuxAssetID = value.String
			}
		case post.FieldMuxPlaybackID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field mux_playback_id", values[i])
			} else if value.Valid {
				po.MuxPlaybackID = value.String
			}
		case post.FieldPrice:
...
func (po *Post) String() string {
	...
	builder.WriteString(po.ThumbnailURL)
	builder.WriteString(", ")
	builder.WriteString("video_url=")
	builder.WriteString(po.VideoURL)
	builder.WriteString(", ")
	builder.WriteString("mux_asset_id=")
	builder.WriteString(po.MuxAssetID)
	builder.WriteString(", ")
	builder.WriteString("mux_playback_id=")
	builder.WriteString(po.MuxPlaybackID)
	builder.WriteString(", ")
