...
func (su *SubscriptionUpdate) AddPostIDs(ids ...string) *SubscriptionUpdate {
...
func (su *SubscriptionUpdate) RemovePostIDs(ids ...string) *SubscriptionUpdate {
...
// AddPostIDs adds the "posts" edge to the Post entity by IDs.
func (suo *SubscriptionUpdateOne) AddPostIDs(ids ...string) *SubscriptionUpdateOne {
...
// RemovePostIDs removes the "posts" edge to Post entities by IDs.
func (suo *SubscriptionUpdateOne) RemovePostIDs(ids ...string) *SubscriptionUpdateOne {
